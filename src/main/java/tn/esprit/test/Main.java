...
//        UserService ps = new UserService();
       ...
       // pt.add(p1);
        //pt.add(p2);
       // pt.add(p3);
//        int s5=pt.obtenirIdSalle("Terrain Lake Club");
//        System.out.println(s5);

//System.out.println(pt.readByID(29));
//        System.out.println(pt.readByNom("Marselone"));
//
        User u1 = new User("SmatiHadil", "hadil", "smati", 23, "hadilsmati99@gmail.com", "1234", 54034540);
       User u2=new User("khalfions","ons","khalfi",50,"chihidorsaf99@gmail.com" ,"1234" ,54034540);
       User u3=new User("wesltimariem","mariem","wesleti",30,"chihidorsaf99@gmail.com" ,"1234" ,54034540);
        UserService ps = new UserService();
//        ps.add(u1);
//         ps.add(u2);
//         ps.add(u3);
//        ReservationTerrain r1=new ReservationTerrain("hello",29,1);
   ReservationService R = new ReservationService();
//        R.add(r1);
System.out.println(R.readAll2());
    }
}