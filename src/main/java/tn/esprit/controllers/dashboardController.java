...
/*
    ...
    public class dashboardController implements Initializable {
        ...
        @FXML
        private TableColumn<?, String> addEmployee_col_employeeID;

        @FXML
        private TableColumn<?, String> addEmployee_col_firstName;

        @FXML
        private TableColumn<?, String> addEmployee_col_lastName;

        @FXML
        private TableColumn<?, String> addEmployee_col_gender;

        @FXML
        private TableColumn<?, String> addEmployee_col_phoneNum;

        @FXML
        private TableColumn<?, String> addEmployee_col_position;

        @FXML
        private TableColumn<?, String> addEmployee_col_date;
        ...
        @FXML
        private TableColumn<?, String> salary_col_employeeID;

        @FXML
        private TableColumn<?, String> salary_col_firstName;

        @FXML
        private TableColumn<?, String> salary_col_lastName;

        @FXML
        private TableColumn<?, String> salary_col_position;

        @FXML
        private TableColumn<?, String> salary_col_salary;
